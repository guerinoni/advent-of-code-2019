...
impl Solver for Day3 {
    fn new(input_file: &'static str) -> Day3 {
        Day3 {
            filename: input_file,
        }
    }
    ...
    fn solve(&self) -> String {
        ...
        let p2 = self.part2(vec1.as_slice(), vec2.as_slice());
...
impl Day3 {
    fn part1(&self, wire1: &[&str], wire2: &[&str]) -> u64 {
...
impl Day3 {
    fn part2(&self, wire1: &[&str], wire2: &[&str]) -> u64 {
        let points1 = get_points(wire1);
        let points2 = get_points(wire2);
        let lines1 = make_lines(&points1);
        let lines2 = make_lines(&points2);
...
mod tests {
    ...
    fn validation() {
        ...
        let input1 = "R8,U5,L5,D3".split(',').collect::<Vec<_>>();
        let input2 = "U7,R6,D4,L4".split(',').collect::<Vec<_>>();
        assert_eq!(d.part1(&input1, &input2), 6);
        assert_eq!(d.part2(&input1, &input2), 30);
        ...
        let input2 = "U62,R66,U55,R34,D71,R55,D58,R83"
            .split(',')
            .collect::<Vec<_>>();
        assert_eq!(d.part1(&input1, &input2), 159);
        assert_eq!(d.part2(&input1, &input2), 610);
